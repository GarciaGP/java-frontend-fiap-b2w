						...
						<div class="content">
							...
							<div class="card-deck">
								<div class="card">
									...
									<img src="../../Styles/images/Cursos/b2w1.png"
										class="card-img-top" alt="..." />
									<div class="card-body">
										<p class="card-text">Neste curso você verá quais são os
											setores de sua companhia de forma detalhada, e como funcionam</p>
										<span>Setor: Gestão de Pessoas</span> <span>Prazo de
											execução: 11/12/2020</span> <span>Status: em andamento</span> <a
											href="./TakeCourse.jsp" class="btn btn-primary text-center">Começar!</a>
										<div class="progress">
								...
								<div class="card">
									...
									<img src="../../Styles/images/Cursos/etica.jpeg"
										class="card-img-top" alt="..." />
									<div class="card-body">
										<p class="card-text">Aqui você aprenderá como é nosso
											código de conduta e ética de uma forma descontraída.</p>
										<span>Setor: Gestão de pessoas</span> <span>Prazo de
											execução: 11/12/2020</span> <span>Status: Não iniciado</span> <a
											href="#" class="btn btn-secondary text-center">Indisponível</a>
										<div class="progress">
											<div class="progress-bar" role="progressbar"
								...
								<div class="card">
									...
									<img src="../../Styles/images/Cursos/pexels.jpg"
										class="card-img-top" alt="..." />
									<div class="card-body">
										<p class="card-text">Neste curso você verá atividades
											desenvolvidas na área tecnológica, e práticas a serem
											seguidas.</p>
										<span>Setor: Tecnologia</span> <span>Prazo de execução:
											11/12/2020</span> <span>Status: em andamento</span> <a href="#"
											class="btn btn-secondary">Indisponível</a>
										<div class="progress">
											<div class="progress-bar" role="progressbar"
												style="width: 25%;" aria-valuenow="25" aria-valuemin="0"
												aria-valuemax="100">25%</div>
